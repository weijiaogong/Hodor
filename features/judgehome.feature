...
Feature: Assignments of judges
    ...
    Scenario: I should see 3 unscored posters when judge logged in for the first time 
    ...
    Scenario: Judge can accept new poster and grade it from list of orphan posters 
        ...
        Then  I should see the following table "#assigned_posters_table":
		  ...
		  | 3      |Wireless Network| -     |     |
		  | 4      |Algorithm       | 4.600 |     |
		And  The grade button for poster #4 in table "#assigned_posters_table" should be disabled
